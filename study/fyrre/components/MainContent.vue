  ...
  <div id="content">
    ...
    <section class="section">
      <div class="main-title-svg">
        <svg width="1520" height="216" viewBox="0 0 1520 216" fill="none"
          ...
          <path
              ...
              fill="black"/>
          <path d="M528.688 212.622V40.5699H595.91V0H416.751V40.5699H483.676V212.622H528.688Z"
                fill="black"/>
          <path
          ...
          <path d="M1253.67 212.622V131.482H1331.55V92.6889H1253.67V39.0893H1346.06V0H1208.66V212.622H1253.67Z"
                fill="black"/>
          <path d="M1520 173.533H1421.98V122.598H1509.04V83.805H1421.98V39.0893H1517.93V0H1376.97V212.622H1520V173.533Z"
                fill="black"/>
        </svg>
      </div>
      <div class="main-newsticker">
        <div class="ticker-title">
          NEWS TICKER+++
        </div>
        <!--    news-ticker component    -->
        <news-ticker :news-ticker-list="newsTickerList"></news-ticker>
        <!--    //news-ticker component    -->
      </div>
    </section>

    <section class="section sec-main-mgzn">
      <div class="mgzn-hd">
        <!--        headline-text            -->
        <div class="hl-cont">
          <div class="hl-tit">
            <router-link to="/magazine/2">
              {{ headlineDetail.tit }}
            </router-link>
          </div>
          <div class="hl-txt">
            <div class="hl-desc">
              {{ headlineDetail.description }}
            </div>
              ...
              <div>
                <ul class="detail-list">
                  <li>
                    ...
                    <span class="txt-r">{{ headlineDetail.text }}</span>
                  </li>
                  <li>
                    <span class="tit-r">Date</span>
                    <span class="txt-r">{{ headlineDetail.date }}</span>
                  </li>
                  <li>
                    <span class="tit-r">Duration</span>
                    <span class="txt-r">{{ headlineDetail.duration }}</span>
                  </li>
                </ul>
              </div>
        ...
        <div class="hl-img">
          <router-link to="/magazine/2">
            <img :src="imgPath+headlineDetail.img"
                 alt="Don't close your eyes main banner image">
          </router-link>
        </div>
        <!--        //headline-image            -->
      </div>
      <!--  main magazine list    -->
      <main-magazine-list></main-magazine-list>
      <!--  //main magazine list    -->
    </section>
    <!--  //section |  -->
    ...
    <section class="section section-temp sec-main-podcast">
      <div class="temp-header">
        <div class="section-tit">PODCAST</div>
