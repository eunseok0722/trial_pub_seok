      ...
      <div class="podcast-info">
        <div class="post-profile-wrap">
          <div class="post-cover-img">
            <img :src="require(`~/assets/images/${fndCont.coverImg}`)" :alt="fndCont.tit">
          </div>
            ...
            <div class="name-wrap flex-space-center">
              ...
              <div class="nav-sns">
                ...
                <ul class="nav-sns-list ty2">
                  <li v-for="item in navListenItem" :key="item.id" class="sns-item">
                    <a :href="item.url" target="_blank" title="새창에서 열기">
    ...
    <section class="section section-temp sec-main-podcast">
      <div class="temp-header">
        ...
        <div class="btn-view-more">
          <NuxtLink to="/podcast">ALL EPISODES</NuxtLink >
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    fndCont() {
      const dataBase = this.$store.state.podcast.podcastCont;
      const data = {};
